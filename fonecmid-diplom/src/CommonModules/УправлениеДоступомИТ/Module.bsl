...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// ++ Калашников А.В. 03.12.2025 Добавление Поставляемых профилей БухгалетрИТФирмы,Специалист,Менеджер
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "БухгалетрИТФирмы";
	ОписаниеПрофиля.Идентификатор = "e14fe16f-cb92-11f0-ac3f-f89e944c8109";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'БухгалетрИТФирмы'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	...
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзмененияДенежныхДокументов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_МассовоеСозданиеДоументовРеализации");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОтчетАнализВыставленныхАктов");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "e7f346a7-d04e-11f0-ac42-f89e944c8109";
	...
	ОписаниеПрофиля.Идентификатор = "3d0100ff-d050-11f0-ac42-f89e944c8109";
	...
	ОписаниеПрофиля.Идентификатор = "845667b1-d050-11f0-ac42-f89e944c8109";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОтчетыПоРасчетамССотрудникамиИОтпускам");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОтчетВыработкаСпециалистов");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеНСИ");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	// --Калашников А.В. 03.12.2025
