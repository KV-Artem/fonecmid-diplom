...
Процедура ПриНачалеРаботыСистемы()
	...
	//ВКМ_овмлоаовыоалвыоаловлыаолвылловыд
	
//	Константы.ВКМ_ТокенУправленияТелеграмБотом.Установить("8456349772:AAF3o5e0bSzuDXX51togqVZxf3xaVJSz0HI");
//	Константы.ВКМ_ИдентификаторГруппыДляОповещения("-4809560075");
