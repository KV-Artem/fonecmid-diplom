...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ДипломнаяРабота Калашников А.В. Добавление команды Заполнить на Форму
    ...
    НоваяКнопка = Элементы.Вставить("Кнопка", Тип("КнопкаФормы"),Элементы.ФормаКоманднаяПанель,);
...
//++ДипломнаяРабота Калашников А.В. Добавление команды Заполнить на Форму
 ...
 Процедура ЗаполинтьСервер() 
	 ...
	 Если ВидДоговора = ПредопределенноеЗначение("Перечисление.ВидыДоговоровКонтрагентов.ВКМ_АбонентскоеОбслуживание") Тогда
		 ...
		 ОбъектФормы.ВКМ_ВыполнитьАвтозаполнение();	
		 ЗначениеВРеквизитФормы(ОбъектФормы,"Объект"); 
	 Иначе
	 ОбщегоНазначения.СообщитьПользователю("Ошибка.Команда ""Заполнить"" предназначена только для договоров вида ""Абонентское обслуживание"", поменяйте договор",,,,);		 	 
	 КонецЕсли;
