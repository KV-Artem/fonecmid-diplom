...
|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрРасчета.ВКМ_Удержания.БазаВКМ_ОсновныеНачисления(&Сотрудник, &Сотрудник, &Разрез, Регистратор = &Ссылка) КАК ВКМ_УдержанияБазаВКМ_ОсновныеНачисления
|		ПО (ВТ_Начисление.НомерСтроки = ВКМ_УдержанияБазаВКМ_ОсновныеНачисления.НомерСтроки
|				И ВТ_Начисление.ВидРасчета = ВКМ_УдержанияБазаВКМ_ОсновныеНачисления.ВидРасчетаРазрез)
|ГДЕ
...
|ГДЕ
|	ВКМ_НачисленияЗарплатыНачисления.Ссылка = &Ссылка
|	И ВКМ_НачисленияЗарплатыНачисления.ВидРасчета = ЗНАЧЕНИЕ(ПланВидовРасчета.ВКМ_ДополнительныеНачисления.ПроцентЗаВыолненныеРаботыКлиентам)
|;
|
|////////////////////////////////////////////////////////////////////////////////
|ВЫБРАТЬ
...
|ИЗ
|	ВТ_Начисление КАК ВТ_Начисление
|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрРасчета.ВКМ_Удержания.БазаВКМ_ДополнительныеНачисления(&Сотрудник, &Сотрудник, &Разрез, Регистратор = &Ссылка) КАК ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления
|		ПО (ВТ_Начисление.НомерСтроки = ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.НомерСтроки
|				И ВТ_Начисление.ВидРасчета = ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.ВидРасчетаРазрез)
|ГДЕ
|	ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.ВидРасчетаРазрез = ЗНАЧЕНИЕ(ПланВидовРасчета.ВКМ_ДополнительныеНачисления.ПроцентЗаВыолненныеРаботыКлиентам)";
...
|ИЗ
|	ВТ_Начисление КАК ВТ_Начисление
|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрРасчета.ВКМ_Удержания.БазаВКМ_ОсновныеНачисления(&Сотрудник, &Сотрудник, &Разрез,
